...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                              title="Schematron Version 2.3.0 - XRechnung 3.0.2 compatible - CII"
                              schemaVersion="">
         <xsl:comment>
   ...
   <!--SCHEMATRON PATTERNS-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Schematron Version 2.3.0 - XRechnung 3.0.2 compatible - CII</svrl:text>
   ...
   <!--PATTERN cii-pattern-->
   <!--RULE -->
   <xsl:template match="/rsm:CrossIndustryInvoice" priority="1011" mode="M30">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
